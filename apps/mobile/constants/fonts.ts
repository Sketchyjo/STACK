...
export const FONT_FAMILIES = {
  ...
  // Outward fonts
  OUTWARD_BLOCK: 'Outward-Block',
  OUTWARD_BORDERS: 'Outward-Borders',
  OUTWARD_ROUND: 'Outward-Round',
} as const;
...
export const SEMANTIC_FONTS = {
  ...
  ACCENT: FONT_FAMILIES.OUTWARD_BLOCK,
  DECORATIVE: FONT_FAMILIES.OUTWARD_BORDERS,
  ROUNDED_ACCENT: FONT_FAMILIES.OUTWARD_ROUND,
} as const;
...
export const FONT_CLASSES = {
  ...
  // Outward font family classes
  OUTWARD_BLOCK: 'font-outward-block',
  OUTWARD_BORDERS: 'font-outward-borders',
  OUTWARD_ROUND: 'font-outward-round',
  // Semantic classes
  ...
  ROUNDED_ACCENT: 'font-rounded-accent',
} as const;
...
export const TYPOGRAPHY_PRESETS = {
  ...
  // Outward font presets
  HERO: 'text-4xl font-accent',
  ACCENT_HEADING: 'text-2xl font-accent',
  DECORATIVE_TEXT: 'text-lg font-decorative',
  ROUNDED_ACCENT: 'text-xl font-rounded-accent',
} as const;
